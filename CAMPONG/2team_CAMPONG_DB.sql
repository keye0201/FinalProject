...
insert into `MEMBER`(`USER_NO`,`ID`,`PASSWORD`,`ROLE`,`BIRTHYEAR`,`PHONE`,`EMAIL1`,`EMAIL2`,`ADDRESS`,`KAKAOTOKEN`,`STATUS`,`ENROLL_DATE`,`MODIFY_DATE`,`PROFILE_IMAGE`, `RENAMED_PROFILEIMAGE`) 
