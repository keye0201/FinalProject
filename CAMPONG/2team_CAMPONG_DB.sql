...
insert into `MEMBER`(`ID`,`PASSWORD`,`ROLE`,`BIRTHYEAR`,`NICKNAME`,`PHONE`,`EMAIL1`,`EMAIL2`,`ADDRESS`,`KAKAOTOKEN`,`STATUS`,`ENROLL_DATE`,`MODIFY_DATE`,`PROFILE_IMAGE`,`RENAMED_PROFILEIMAGE`) values('1', 'admin', '$2a$10$ez/mkHzzDuxXVdFjQFnUMOtVohF2Mqe1TZ08aWEfxdF3qTsSc9HnS', 'ROLE_USER', '1970', '관리자', '01011111111', 'aaaaa', ' google.com', '서울', NULL, 'Y', '2023-02-21 10:23:17', '2023-02-21 10:23:17', '0', '0');
