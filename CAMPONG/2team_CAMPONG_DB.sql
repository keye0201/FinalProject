...
insert into `MEMBER`(`USER_NO`,`ID`,`PASSWORD`,`ROLE`,`BIRTHYEAR`,`NICKNAME`,`PHONE`,`EMAIL1`,`EMAIL2`,`ADDRESS`,`KAKAOTOKEN`,`STATUS`,`ENROLL_DATE`,`MODIFY_DATE`,`PROFILE_IMAGE`, `RENAMED_PROFILEIMAGE`) 
values('1', 'admin', '$2a$10$lgsKln73lYMXz3.Fh/hi5.ZnPbs73o0ngY3EcTtPYUwGQ1WpTSXcu', 'ROLE_ADMIN', '1970', '관리자', '01011111111', 'admin', ' google.com', '서울', NULL, 'Y', '2023-02-21 09:31:59', '2023-02-21 09:31:59', '0', '0');
